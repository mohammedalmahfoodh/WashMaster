...
CREATE TABLE IF NOT EXISTS general_plan (
    ...
    voyageId VARCHAR(50)DEFAULT NULL ,
...
CREATE TABLE IF NOT EXISTS tank_plans (
    ...
    general_plan_id VARCHAR(50) default NULL,    
    cleaningMethod VARCHAR(25) DEFAULT NULL,
    cleaningMethod2 int DEFAULT 0,
    nextMarpol VARCHAR(250) default NULL, 
    previousMarpol VARCHAR(250) default NULL,    
    hcLabel  VARCHAR(25) default NULL,
    ...
    tankCoating VARCHAR(50) DEFAULT NULL,
    tankAtmosphere VARCHAR(50) DEFAULT NULL,    
